...
if(NOT ilpsolverif_POPULATED)
  ...
  elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64)$")
    foreach(_platform IN ITEMS manylinux_2_28_x86_64 manylinux_2_24_x86_64 manylinux2014_x86_64)
      if(EXISTS "${ilpsolverif_SOURCE_DIR}/${_platform}/lib/libILPSolverIf.a")
        set(solver_search_path ${ilpsolverif_SOURCE_DIR}/${_platform}/lib)
        message(STATUS "Using prebuilt ILP solver libraries from ${solver_search_path}")
        break()
      endif()
    endforeach()
  endif()
...
target_link_libraries(ILPSolverIf_shared PRIVATE ${cbc_LIBRARIES})]=]
    ...
    set(_ilp_solver_libs ilp_solver_if osicbc_if cbcsolver_if cbc_if cgl_if osiclp_if clpsolver_if clp_if osi_if coinutils_if)
    if(sym_lib)
      list(APPEND _ilp_solver_libs sym_if)
    endif()
    if(osisym_lib)
      list(APPEND _ilp_solver_libs osisym_if)
    endif()
    target_link_libraries(ilp_solver INTERFACE ${_ilp_solver_libs})
